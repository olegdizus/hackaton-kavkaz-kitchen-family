...
function CreatePlanFactKS(grid, options, parseResponseFunction) {
    ...
    var gridColumnsAndGroups = {
        get: function () {
            ...
            if (byPeriods) {
                GetColsFromKSJsonData(valueCols, displayVariant);
            } else {
            ...
            var hierarchyCols = GetPlanFactKSHierarchyFields();
    ...
    var gridBuider = new KendoGridBuider(getGridOptionKS());
    gridBuider.buid();

    function GetColsFromKSJsonData(cols, displayVariant) {

        var url = basePath + 'PlanFactKS/GetValueColumns';
        var dates = getDates();
    ...
    function updateSelectedPeriodsKS() {
        var periodType = $("#periods option:selected").val();
        var dates = getDates();
    ...
    $('#refresh').on('click', function () {
        ...
        refreshGridColumn(getGridOptionKS, options, updateSelectedPeriodsKS);
    });
...
var url = basePath + 'PlanFactKS/GetSubGroups';
...
var CreatePlanFactKSGrid = function (gridDiv, e) {
